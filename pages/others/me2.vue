...
<template>
	<view>
		<view class="myInfo">
			...
			<view class="options">
				<!-- #ifndef H5 -->
				<image src="../../static/icons/icon-scan.png" style="width: 22px;height: 22px;margin-right: 10px;"></image>
				<!-- #endif -->
				
				<image src="../../static/icons/settings.png" style="width: 22px;height: 22px;" ></image>
			</view>
			
			<view class="real-me">
				<image src="../../static/images/me.png" class="my-face"></image>
				...
				<view class="my-name-wrapper">
					...
					<view class="edit-wrapper">
						<view class="edit-my-resume-wrapper">
							<text class="edit-my-resume">慕课网 · 技术经理</text>
						</view>
					</view>
				</view>
			</view>
			...
			<view class="numbers">
				<view class="num-item" @click="gotoMyCollectResume()">
					<text class="num-counts">123</text>
